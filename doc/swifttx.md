...
This mechanism has been integrated into Bitcore-Node-Uidd which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Uidd-Project/insight-api-uidd#web-socket-api](https://github.com/Uidd-Project/insight-api-uidd#web-socket-api) 
* API: [https://github.com/Uidd-Project/insight-api-uidd#swifttx-transactions](https://github.com/Uidd-Project/insight-api-uidd#swifttx-transactions) 
...
By default, the Uidd Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Uidd Core daemon:
