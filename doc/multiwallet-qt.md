...
In order to support loading of multiple wallets in uidd-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is uidd.cpp.
...
Changes to uidd.cpp
----------------------
uidd.cpp is the entry point into uidd-qt, and as such, will require some minor modifications to provide hooks for
