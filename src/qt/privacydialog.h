...
public:
    ...
    void setZUIDDControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzUIDD_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzUIDD_clicked();
    void on_pushButtonZUIDDControl_clicked();
