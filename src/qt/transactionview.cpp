 ...
 */
    ...
    typeWidget->addItem(tr("Received UIDD from zUIDD"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zUIDD"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zUIDD));
