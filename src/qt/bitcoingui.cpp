                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Uidd Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zUIDD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Uidd Core"), this);
    aboutAction->setStatusTip(tr("Show information about Uidd Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Uidd"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Uidd Core help message to get a list with possible Uidd command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Uidd Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Uidd network", "", count));
}
...
{
    QString strTitle = tr("Uidd Core"); // default title
