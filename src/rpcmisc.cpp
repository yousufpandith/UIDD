...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total uidd balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zUIDDsupply\" :\n"
            "  {\n"
			"     \"0.05\" : n,            (numeric) supply of 0.05 zUIDD denomination\n"
			"     \"0.2\" : n,            (numeric) supply of 0.2 zUIDD denomination\n"
			"     \"1\" : n,           (numeric) supply of 1 zUIDD denomination\n"
			"     \"5\" : n,           (numeric) supply of 5 zUIDD denomination\n"
			"     \"20\" : n,          (numeric) supply of 20 zUIDD denomination\n"
			"     \"100\" : n,          (numeric) supply of 100 zUIDD denomination\n"
			"     \"500\" : n,         (numeric) supply of 500 zUIDD denomination\n"
			"     \"2000\" : n,         (numeric) supply of 2000 zUIDD denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zUIDD denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in uidd/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in uidd/kb\n"
    ...
    UniValue zuiddObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zuiddObj.push_back(Pair(to_string(denom * 0.01), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * denom*CENT)));
    }
    zuiddObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zUIDDsupply", zuiddObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"uiddaddress\"\n"
            "\nReturn information about the given uidd address.\n"
            "\nArguments:\n"
            "1. \"uiddaddress\"     (string, required) The uidd address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"uiddaddress\", (string) The uidd address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Uidd address and we have full public key:
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"uiddaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"uiddaddress\"  (string, required) The uidd address to use for the signature.\n"
