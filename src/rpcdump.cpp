...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"uiddaddress\"\n"
            "\nReveals the private key corresponding to 'uiddaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"uiddaddress\"   (string, required) The uidd address for the private key\n"
            "\nResult:\n"
...
UniValue dumpwallet(const UniValue& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by Uidd %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
...
UniValue bip38encrypt(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"uiddaddress\"\n"
            "\nEncrypts a private key corresponding to 'uiddaddress'.\n"
            "\nArguments:\n"
            "1. \"uiddaddress\"   (string, required) The uidd address for the private key (you must hold the key already)\n"
