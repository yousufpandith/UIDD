...
#   c) node1 mines 32 blocks, so now node 0 has 60001uidd, node 1 has 4250uidd, node2 has none.
#   d) node0 sends 601 uidd to node2, in two transactions (301 uidd, then 300 uidd).
