...
RESOURCES += src/qt/uidd.qrc src/qt/uidd_locale.qrc

TRANSLATIONS += src/qt/locale/uidd_bg.ts \
                src/qt/locale/uidd_de.ts \
                src/qt/locale/uidd_en.ts \
                src/qt/locale/uidd_es.ts \
                src/qt/locale/uidd_fi.ts \
                src/qt/locale/uidd_fr.ts \
                src/qt/locale/uidd_it.ts \
                src/qt/locale/uidd_ja.ts \
                src/qt/locale/uidd_pl.ts \
                src/qt/locale/uidd_pt.ts \
                src/qt/locale/uidd_ru.ts \
                src/qt/locale/uidd_sk.ts \
                src/qt/locale/uidd_sv.ts \
                src/qt/locale/uidd_vi.ts \
                src/qt/locale/uidd_zh_CN.ts \
                src/qt/locale/uidd_zh_TW.ts
