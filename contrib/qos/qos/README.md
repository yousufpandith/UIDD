...
This means one can have an always-on uiddd instance running, and another local uiddd/uidd-qt instance which connects to this node and receives blocks from it.
