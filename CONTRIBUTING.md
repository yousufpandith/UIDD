Contributing to Uidd Core
==============================

The Uidd Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Uidd Core project, and is not to be
confused with overall Uidd Network Protocol consensus changes.

Whether a pull request is merged into Uidd Core rests with the project merge
...
Patches that change Uidd consensus rules are considerably more involved than
...
Where a patch set proposes to change the Uidd consensus, it must have been
...
The project leader is the release manager for each Uidd Core release.
